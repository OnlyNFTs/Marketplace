...
getSupportedTokens = async () => {
  ...
  getMarketQuote = async () => {
       var priceTest = new BigNumber(onftsPriceBNB * 4000000 );
       console.log(priceTest);
       var pricelol = priceTest.toString();
       console.log(pricelol);
       let amount1 = Number(Moralis.Units.ETH('1.3'));
    ...
    if (quote.toTokenAmount) {
      ...
      console.log(quote2);
      console.log(quote2.toTokenAmount);
    }
  }
